...
Dependencies
---------------------
A number of [open source libraries](https://github.com/CodeGeass/codegeass/blob/master/doc/dependencies.md) are required in order to be able to build CodeGeass.
...
The [external dependencies](https://github.com/CodeGeass/codegeass/blob/master/doc/dependencies.md) required for building are:
